            ...
            <asp:TemplateField HeaderText="FILENAME">
                <ItemTemplate>
                    <asp:HyperLink ID="HyperLink1" runat="server" Visible="false"
                        NavigateUrl='<%# Eval("FILENAME", "\\\\dalpvapp013\\shared$\\PTS_Exports\\{0}") %>' 
                        Text='<%# Eval("FILENAME") %>'></asp:HyperLink>
                    <asp:HyperLink ID="HyperLink2" runat="server" Visible="false"
                        NavigateUrl='<%# Eval("FILENAME", "\\\\dalpvapp013\\shared$\\RTS_Exports\\{0}") %>' 
                        Text='<%# Eval("FILENAME") %>'></asp:HyperLink>
                    <asp:HyperLink ID="HyperLink3" runat="server" Visible="false"
                        NavigateUrl='<%# Eval("FILENAME", "\\\\dalpvapp013\\shared$\\MTS_Exports\\{0}") %>' 
                        Text='<%# Eval("FILENAME") %>'></asp:HyperLink> 
                </ItemTemplate>                
            </asp:TemplateField>
            <asp:BoundField
